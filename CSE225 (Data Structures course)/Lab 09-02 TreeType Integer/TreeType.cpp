...
template<class ItemType>
void printPreTree(TreeNode<ItemType>* tree, ofstream& out)
{
    if(tree != NULL)
    {
        out << tree->info << " ";
        printPreTree(tree->left, out);
        printPreTree(tree->right, out);
    }
}
template<class ItemType>
void TreeType<ItemType>::Preprint(ofstream& out)const
{
    printPreTree(root, out);
}

template<class ItemType>
void printPostTree(TreeNode<ItemType>* tree, ofstream& out)
{
    if(tree != NULL)
    {
        printPostTree(tree->left, out);
        printPostTree(tree->right, out);
        out << tree->info << " ";
    }
}
template<class ItemType>
void TreeType<ItemType>::Postprint(ofstream& out)const
{
    printPostTree(root, out);
}

template<class ItemType>
int findmax(TreeNode<ItemType>* tree)
{
    while(tree->right != NULL) tree= tree->right;
...
template<class ItemType>
int TreeType<ItemType>::FindMax()const
{
    return findmax(root);
}

template<class ItemType>
bool check(TreeNode<ItemType>* tree)
{
   bool balanced = true;

   if(tree->left == NULL && tree->right == NULL) return balanced;
   if(tree->left == NULL || tree->right == NULL) return (balanced = false);
...
template<class ItemType>
bool TreeType<ItemType>::isBalanced()const
{
    return check(root);
}
